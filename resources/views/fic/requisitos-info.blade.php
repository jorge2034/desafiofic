<section>
    <div x-data="app()" x-cloak>
		<div class="max-w-4xl mx-auto px-4 py-10">
			...
			<div x-show.transition="step === 'complete'">
				<div class="bg-white rounded-lg p-10 flex items-center shadow justify-between">
					<div>
						...
						<h2 class="text-2xl mb-4 text-gray-800 text-center font-bold">Consulta exitosa</h2>

						<div class="text-gray-600 mb-8">
							Debes dirigirte al municipio de tu comuna y presenta la documentación solicitada
						</div>
			...
			<div x-show.transition="step != 'complete'">
				...
				<div class="border-b-2 py-4">
					<div class="uppercase tracking-wide text-xs font-bold text-gray-500 mb-1 leading-tight" x-text="`Paso: ${step} de 3`"></div>
					<div class="flex flex-col md:flex-row md:items-center md:justify-between">
						<div class="flex-1">
							<div x-show="step === 1">
								<div class="text-lg font-bold text-gray-700 leading-tight">Constituir una empresa</div>
							</div>

							<div x-show="step === 2">
								<div class="text-lg font-bold text-gray-700 leading-tight">Formalizar ante el SII</div>
							</div>

							<div x-show="step === 3">
								<div class="text-lg font-bold text-gray-700 leading-tight">Presentar documentación en municipio</div>
							</div>
						</div>
				...
				<div class="py-10">
					<div x-show.transition.in="step === 1">
						<div class="mb-5 text-center">
							<div class="mx-auto w-36 h-36 border rounded-full relative bg-gray-100 mb-4 shadow-inset">
								<img id="image" class="object-cover w-full pt-12 pl-2 pr-2" src="https://www.registrodeempresasysociedades.cl/img/logo-emp2.png" />
							</div>

                            <a href="https://www.registrodeempresasysociedades.cl" target="_blank">
							<label
								type="button"
								class="cursor-pointer inine-flex justify-between items-center focus:outline-none border py-2 px-4 rounded-lg shadow-sm text-left text-gray-600 bg-white hover:bg-gray-100 font-medium"
							>
								<svg xmlns="http://www.w3.org/2000/svg" class="inline-flex flex-shrink-0 w-4 h-4 -mt-2 mr-1" viewBox="0 0 27 27" stroke-width="0.5" stroke="currentColor" fill="none" >
							...
							<div class="mx-auto w-48 text-gray-500 text-xs text-center mt-1">Para constituir tu empresa presiona el boton: </div>
					...
					<div x-show.transition.in="step === 2">
						...
						<div class="mb-5 text-center">
							<div class="mx-auto w-36 h-36 border rounded-full relative bg-gray-100 mb-4 shadow-inset">
								<img id="image" class="object-cover w-full pt-12 pl-2 pr-2" src="https://homer.sii.cl/responsive/images/logo.jpg" />
							</div>
							...
							<div class="mx-auto w-48 text-gray-500 text-xs text-center mt-1">Crea tu cuenta de usuario en el portal del SII e ingresa la información solicitada.  </div>
					...
					<div x-show.transition.in="step === 3">
						<div class="mb-5">
							<label for="email" class="font-bold mb-1 text-gray-700 block">Debes dirigirte al municipio de tu comuna y presenta la documentación solicitada. Los documentos son los siguientes:</label>
						</div>
                        <hr>
                         <ul class="list-disc text-blue-850 ml-4 m-auto">
                                    @foreach ($requisitos as $item)
                                        @php
                                        $rubro = $item->rubro->name;
                                        $comuna = $item->comuna->name;
                                        @endphp
                                        <li>{{$item->documento->name;}}</li>

                                    @endforeach
                            </ul>
                        <hr>
						<div class="mb-5 mt-5">
							<label for="profession" class="font-bold mb-1 text-gray-700 block">Rubro: </label>{{$rubro}}<br>
                            <label for="profession" class="font-bold mb-1 text-gray-700 block">Comuna: </label>{{$comuna}}
						</div>
					</div>
				</div>
				<!-- / Step Content -->
		...
		<!-- Bottom Navigation -->
		<div class="py-3 x-show="step != 'complete'">
